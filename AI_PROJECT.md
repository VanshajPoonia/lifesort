...
- Life Areas at `app/life-areas/page.tsx` and `app/life-areas/[id]/page.tsx`, providing user-owned cross-module organization with default areas, icons, colors, descriptions, ordering, and a detail view that gathers filtered linked tasks, goals, habits, projects, notes, budget categories, and wishlist items.
